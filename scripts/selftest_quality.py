...
def main()->int:
 ...
 with tempfile.TemporaryDirectory() as td:
  ...
  # faceted BREP cannot reach CAD-L3
  ...
  r=run([sys.executable,str(ROOT/'scripts/cad_maturity_gate.py'),'--manifest',str(p),'--target','CAD-L3'])
  if r.returncode==0: failures.append('faceted BREP incorrectly passed CAD-L3')
